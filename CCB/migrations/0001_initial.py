...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_id', models.IntegerField(db_column='Order ID')),
                ('design_id', models.CharField(db_collation='Chinese_Taiwan_Stroke_CI_AS', db_column='Design ID', max_length=10)),
                ('speed', models.CharField(db_collation='Chinese_Taiwan_Stroke_CI_AS', db_column='Speed', max_length=10)),
                ('temperature_spec', models.CharField(blank=True, db_collation='Chinese_Taiwan_Stroke_CI_AS', db_column='Temperature Spec', max_length=10, null=True)),
